"""Regression checks for the anchor-algo-geometry-stack casebook."""
...
from casebook.harness import assert_expected, anchor_algo_geometry_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(anchor_algo_geometry_stack_summary(), assert_expected())
