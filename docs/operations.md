...
`anchor-algo-geometry-stack` is centered on algorithms work in OCaml. The technical target is: Package an OCaml local lab for geometry analysis with transition tables, invalid-transition tests, and documented operating limits.
