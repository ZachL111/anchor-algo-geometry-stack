...
anchor-algo-geometry-stack is a OCaml project for algorithms. It focuses on this technical goal: Package an OCaml local lab for geometry analysis with transition tables, invalid-transition tests, and documented operating limits.
